...
/*
    This class takes example of checking a string has all the characters unique or not using bit vector
...
public class BitVector {
     ...
     */
        ...
        Since this number is different from '0' it means that the character
        ...
        value it hasn't seen, by doing an OR between checker and the value
